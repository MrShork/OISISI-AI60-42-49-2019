...
public class BaseofSoftware {
	...
	static Cetkica c4 = new Cetkica("DamStandard","ClayTubes", "Pinch");
	...
	static Softver s4 =new Softver(Naziv.Photoshop, new ArrayList<Cetkica>(List.of(c4)), ".psd", "Slika", new Render("Metal", "4", "Organski", "Arnold"));
